...
initPop;
options = optimoptions('ga', 'PlotFcn', 'gaplotbestf', 'FunctionTolerance', 10e-8, 'MaxStallGenerations', 200, 'InitialPopulation',IP);
...
%     patch('XData', [drawvec(i) drawvec(i) drawvec(i)+Ared(2,drawvec(i)) Ared(2,drawvec(i))]*skalierung, 'YData', [lifetime(drawvec(i)) 4 4 lifetime(drawvec(i))], 'EdgeColor', 'none', 'FaceColor', 'red', 'FaceAlpha', 0.5);
% end
